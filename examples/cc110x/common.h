...
#elif (defined BOARD_ID_lqfp48_usb_uext)
#ifdef STM32F1xx
typedef GPIO_T<PA, 2, INPUT, FLOATING, LOW, INTERRUPT_ENABLED, EDGE_FALLING> CC1101_IRQ;
#else
...
#ifdef STM32F1xx
typedef GPIO_T<PB, 1, INPUT, FLOATING, LOW, INTERRUPT_ENABLED, EDGE_FALLING> CC1101_IRQ;
#else
typedef GPIO_T<PB, 1, MODE_INPUT, TYPE_PUSH_PULL, SPEED_LOW, PULL_NONE, AF0, EDGE_FALLING> CC1101_IRQ;
#endif
typedef GPIO_OUTPUT_T<PA, 4> CC1101_CSN;
typedef GPIO_INPUT_T<PA, 6> MISO_IN;
#endif
...
#else
typedef SPI_T<SYSCLK, true, 0, 4000000> SPI;
#endif
