...
#define USBG               ((USB_OTG_GREGS *) (USB_OTG_FS_BASE_ADDR + USB_OTG_CORE_GLOBAL_REGS_OFFSET))
#define USBD               ((USB_OTG_DREGS *) (USB_OTG_FS_BASE_ADDR + USB_OTG_DEV_GLOBAL_REG_OFFSET))
#define USBH               ((USB_OTG_HREGS *) (USB_OTG_FS_BASE_ADDR + USB_OTG_HOST_GLOBAL_REG_OFFSET))
#define USBDIEP            ((USB_OTG_INEPREGS **) (USB_OTG_FS_BASE_ADDR + USB_OTG_DEV_IN_EP_REG_OFFSET))
#define USBDOEP            ((USB_OTG_OUTEPREGS **) (USB_OTG_FS_BASE_ADDR + USB_OTG_DEV_OUT_EP_REG_OFFSET))
...
typedef bool(*DESCRIPTOR_CALLBACK)(uint8_t type, uint8_t index, const uint8_t** descriptor, uint32_t* length);
typedef bool(*SETUP_CALLBACK)(SETUP_PACKET *packet, const uint8_t** response_data, uint32_t* length);
